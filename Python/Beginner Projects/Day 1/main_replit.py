...
print("""I am signing up for Replit's 100 days of Python challenge!/n
...
print("I am feeling motivated to finish!")
print("You can follow my progress at replit.com/@Vladdstian")
